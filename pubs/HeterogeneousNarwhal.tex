...
\begin{quote}
  ...
  \todo{%
    \href{https://dl.acm.org/doi/10.1145/3212734.3212736%
    }{%
...
one is running a validator on two chains,
and if it is the case that one proposes 
a block on both chains,
one can split up the atomic swap into two transactions,
