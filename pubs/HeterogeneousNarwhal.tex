...
\begin{abstract}
  ...
  we can accomodate for a directed acyclic graph (\Dag) of blocks.
  In fact,
  ...
  \todo{%
    we actually need to explain how we can replace bridges!
  }
...
\section{Overview: mem-\Dag[s], heterogeneity, etc.}
\label{sec:overview}

\paragraph{Atomic cross-chain swaps}
...
\begin{quote}
  ...
  \todo{\href{https://dl.acm.org/doi/10.1145/3212734.3212736}{Atomic Cross-Chain Swaps} }
\end{quote}
