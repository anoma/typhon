...
\* BEGIN TRANSLATION (chksum(pcal) = "8b0767cd" /\ chksum(tla) = "61a62904")
VARIABLES maxBal, votesSent, 2avSent, received, msgs
...
vars == << maxBal, votesSent, 2avSent, received, msgs >>

ProcSet == (Ballot) \cup (SafeAcceptor) \cup (FakeAcceptor)
